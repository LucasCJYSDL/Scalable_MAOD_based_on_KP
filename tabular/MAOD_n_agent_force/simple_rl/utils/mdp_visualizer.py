...
def visualize(mdp, draw_state, cur_states, screen=None, scr_width=720, scr_height=720, filename=""):
    '''
    Args:
        mdp (MDP)
...
def visualize_option(mdp, draw_option, option_list, intra_policy_list, action_char_dict, scr_width=720, scr_height=720):
    '''
    Args:
        mdp (MDP)
        policy (lambda: S --> A)

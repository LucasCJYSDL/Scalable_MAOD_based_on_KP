...
class AbstractionWrapper(Agent):
    ...
    def __init__(self, SubAgentClass=None, agent_params={}, agent=None,
                    state_abstr=None, action_abstr=None, name_ext="-abstr", agent_id=None):
        ...
        Agent.__init__(self, name=self.agent.name + name_ext, actions=all_actions, agent_id=agent_id) # high-level agent
    ...
    def act(self, ground_state, reward, is_final=False, learning=True):
        ...
        if self.action_abstr is not None:
            ...
            ground_action = self.agent.act(abstr_state, reward, is_final=is_final)

...
from agents.single.customized.base import EnvWorker
...
class DummyEnvWorker(EnvWorker):
    ...
    def reset(self, random_init: bool=False, is_sample: bool=False) -> Any:
        return self.env.reset(random_init=random_init, is_sample=is_sample)

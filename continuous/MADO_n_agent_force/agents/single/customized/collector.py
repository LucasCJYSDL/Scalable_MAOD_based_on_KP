...
from agents.single.customized.venvs import BaseVectorEnv, DummyVectorEnv
...
class Collector(object):
    ...
    def reset_env(self) -> None:
        ...
        obs = self.env.reset(random_init=self.random_init, is_sample=self.is_sample)
        # print("Init: ", obs)
    ...
    def collect(
        ...
        while True:
            ...
            if np.any(done):
                ...
                obs_reset = self.env.reset(env_ind_global, random_init=self.random_init, is_sample=self.is_sample)
                if self.preprocess_fn:

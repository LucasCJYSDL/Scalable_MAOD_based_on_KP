...
class GridWorldMDP(MDP):
    ...
    def get_env_info(self):
        env_info = {}
        env_info['n_actions'] = len(GridWorldMDP.ACTIONS)
        env_info['n_agents'] = self.agent_num
        env_info['state_shape'] = 2 * self.agent_num
        env_info['obs_shape'] = 2
        env_info['episode_limit'] = 200
        return env_info
...
if __name__ == '__main__':
    grid_world = make_grid_world_from_file(file_name='txt_grids/maze6.txt')
    ...
    grid_world.reset()
    grid_world.visualize(grid_world.get_init_states(), filename="maze")
